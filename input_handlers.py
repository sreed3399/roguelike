...
class HistoryViewer(EventHandler):
    ...
    def ev_keydown(self, event: tcod.event.KeyDown) -> Optional[MainGameEventHandler]:
        ...
        elif event.sym == kb.HOME:
            self.cursor = 0  # Move directly to the top message.
        elif event.sym == kb.END:
...
class SelectIndexHandler(AskUserEventHandler):
    ...
    def ev_keydown(self, event: tcod.event.KeyDown) -> Optional[ActionOrHandler]:
        ...
        if key in MOVE_KEYS:
            ...
            if event.mod & (kb.LSHIFT | kb.RSHIFT):
                modifier *= 5
            if event.mod & (kb.LCTRL | kb.RCTRL):
                modifier *= 10
            if event.mod & (kb.LALT | kb.RALT):
                modifier *= 20
...
class fbtest(SelectIndexHandler) :
    """Lets the player look around using the keyboard."""
    def __init__(
        self,
        engine: Engine,
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        for a in range(r+1):
            for b in range(r+1):
                console.rgb[x+a,y+b] = ord("*"), color.white, color.red
                console.rgb[x-a,y-b] = ord("*"), color.white, color.red
                console.rgb[x+a,y-b] = ord("*"), color.white, color.red
                console.rgb[x-a,y+b] = ord("*"), color.white, color.red
...
class AreaRangedAttackHandler(SelectIndexHandler):
    ...
    def on_render(self, console: tcod.console.Console) -> None:
        ...
        console.rgb[x,y] = ord("*"), color.white, color.red
...
class AreaRangedAttackHandler2(SelectIndexHandler):
    """Handles targeting an area within a given radius. Any entity within the area will be affected."""
